...
\begin{sol}
    \begin{itemize}
        ...
        \end{align}
        三维时, 对于能量本征态 $\lvert n_1,n_2,n_3\rangle$,
        \begin{align}
            \notag\langle\frac{\bm{p}^2}{m}\rangle=&\frac{1}{m}\langle n_1,n_2,n_3\rvert(p_1^2+p_2^2+p_3^2)\lvert n_1,n_2,n_3\rangle=\frac{1}{m}[\langle n_1\rvert p_1^2\lvert n_1\rangle+\langle n_2\rvert p_2^2\lvert n_2\rangle+\langle n_3\rvert p_3^2\lvert n_3\rangle]\\
            =&\hbar\omega_1\left(n_1+\frac{1}{2}\right)+\hbar\omega_2\left(n_2+\frac{1}{2}\right)+\hbar\omega_3\left(n_3+\frac{1}{2}\right),\\
            \notag\langle\bm{x}\cdot\nabla V\rangle=&\langle x_1\frac{\mathrm{d}(m\omega_1^2x_1^2/2)}{\mathrm{d}x_1}+x_2\frac{\mathrm{d}(m\omega_2^2x_2^2/2)}{\mathrm{d}x_2}+x_3\frac{\mathrm{d}(m\omega_3^2x_3^2/2)}{\mathrm{d}x_3}\rangle\\
            \notag=&\langle n_1,n_2,n_3\rvert m\omega_1^2x_1^2+m\omega_2^2x_2^2+m\omega_3^2x_3^2\lvert n_1,n_2,n_3\rangle\\
            \notag=&m\omega_1\langle n_1\rvert x_1^2\lvert  n_1\rangle+m\omega_2^2\langle n_2\rvert x_2^2\lvert n_2\rangle+m\omega_3^2\langle n_3\rvert x_3^2\lvert n_3\rangle\\
            =&\hbar\omega_1\left(n_1+\frac{1}{2}\right)+\hbar\omega_2\left(n_2+\frac{1}{2}\right)+\hbar\omega_3\left(n_3+\frac{1}{2}\right),\\
